package com.triwaluyo07.androidsubmission2.receiver
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object{
        ...
        private const val ID_REPEATING = 212
    }
    ...
    private fun sendNotification(context: Context) {
        val intent = context?.packageManager.getLaunchIntentForPackage("com.triwaluyo07.androidsubmission2")
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setContentText("Search your favorite user now!!!")
            .setAutoCancel(true)
